...
//    set(L, LUA_RIDX_LAST, T::className);	

	lua_pushstring(L, T::className); // 5.2 버전 체인지
    lua_insert(L, -2);  // swap value and key
	lua_setglobal(L, T::className); //5.2 버전에서 LUA_GLOBALSINDEX 는 삭제됨
